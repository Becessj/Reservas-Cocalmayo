...
<head>
  ...
  <link rel="icon" href="logo07.png" type="image/x-icon">
  <!-- Font Awesome Icons -->
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="" class="navbar-brand">
        <img src="logo07.png" style="width: 30px" alt="" class="brand-image img-circle elevation-3"
             style="opacity: .8">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> BUSCAR RESERVA <small></small></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                          ...
                          <div id="div_buscartramite">
                            <div class="card card-success">
                              <div class="card-header">
                                <h3 class="card-title"><b>Ingrese el código de reserva tal como aparece en el formato de reservas.</b></h3>
